...
import { acceptMatchRequest } from "";

// import { useParams } from "react-router-dom";
// import { ToastContainer, toast } from "react-toastify";
import MsgDisplay from "../message/MsgDisplay";
import AnanomMsgDisplay from "../AnanomousUser/AnanomMsgDisplay";
// import UserCard from "../../UserCard";
import AnanomMessageCard from "../AnanomousUser/saveAnanomMessages/UserCard";
...
const AnanomUserChat = (props) => {
  ...
  const { auth, ananomMessages, theme } = useSelector(
    (state) => state
  );
  const { id } = useParams();
